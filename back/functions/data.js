export async function getData(req, res) {
  try {
    const gare_depart = req.query.gare_depart;
    const gare_arrivee = req.query.gare_arrivee;

    if (!gare_depart || !gare_arrivee) {
      return res.status(400).json({ error: "Paramètres gare_depart et gare_arrivee requis" });
    }

    const response_nb_train_prevu = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_train_prevu&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_nb_annulation = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_annulation&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_nb_train_depart_retard = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_train_depart_retard&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_retard_moyen_depart = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=retard_moyen_depart&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_retard_moyen_tous_trains_depart = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=retard_moyen_tous_trains_depart&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_nb_train_retard_arrivee = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_train_retard_arrivee&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_retard_moyen_tous_trains_arrivee = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=retard_moyen_tous_trains_arrivee&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_nb_train_retard_sup_30 = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_train_retard_sup_30&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_nb_train_retard_sup_60 = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=nb_train_retard_sup_60&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_prct_cause_infra = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=prct_cause_infra&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_prct_cause_gestion_trafic = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=prct_cause_gestion_trafic&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_prct_cause_materiel_roulant = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=prct_cause_materiel_roulant&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
    ...
    const response_prct_cause_prise_en_charge_voyageurs = await fetch(
      `https://ressources.data.sncf.com/api/explore/v2.1/catalog/datasets/regularite-mensuelle-tgv-aqst/records?select=prct_cause_prise_en_charge_voyageurs&where=gare_depart%20LIKE%20%22${gare_depart}%22%20AND%20gare_arrivee%20LIKE%20%22${gare_arrivee}%22%20AND%20date%20%3E%3D%20%222024-12-01%22%20AND%20date%20%3C%20%222025-01-01%22`
    );
